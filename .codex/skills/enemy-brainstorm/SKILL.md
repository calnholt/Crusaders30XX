...
description: Start an enemy brainstorming session for Crusaders30XX with full design context loaded. Use when the user wants to design, refine, or validate a new enemy concept, attack pattern, condition set, or difficulty tier.
---
...
5. When the user is happy with a direction, summarize the final design using the checklist from `AGENTS.md`
