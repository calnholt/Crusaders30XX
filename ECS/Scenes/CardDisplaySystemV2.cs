    ...
    public class CardDisplaySystemV2 : CardDisplayBase
    {
        ...
        public void DrawCardV2(Entity entity, Vector2 position)
        {
            ...
            if (hasDef && !string.IsNullOrEmpty(card.CardId))
            {
                ...
                if (artTex != null)
                {
                    float artW = V2ArtWidth * vs;
                    float artH = V2ArtHeight * vs;
                    ...
                    float artLocalX = sw - artW + V2ArtOffsetRight * vs;
                    float artLocalY = sh - artH + V2ArtOffsetBottom * vs;
            ...
            CardData.CardColor cc, CardBase card, int waivedPipCount, bool isColorless)
        {
            ...
            V2Text(cardCenter, rotation, new Vector2(nameX, cursorY), name, nameColor, nameScale, vs, _nameFont);
            ...
            if (hasCost)
            {
                ...
                V2Text(cardCenter, rotation, new Vector2(leftX, textCenterY), costLabel, costLabelColor, costLabelScale, vs, _bodyFont);
                ...
                V2Text(cardCenter, rotation, new Vector2(typeX, cursorY), typeLabel, typeColor, typeScale, vs, _bodyFont);
            }
            else
            {
            ...
            CardData.CardColor cc, float x, float y, string label, ChipVariant variant, bool isColorless)
        {
            ...
            V2Text(cardCenter, rotation, new Vector2(textX, textY), label, textColor, labelScale, vs, _bodyFont);
        }
            ...
            float x, float y, float chipW, float chipH, string value, Color color)
        {
            ...
            V2Text(cardCenter, rotation, new Vector2(valX, valY), value, color, valScale, vs, _nameFont);
        }
