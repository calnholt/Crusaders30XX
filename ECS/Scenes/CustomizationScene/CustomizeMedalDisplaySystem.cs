...
{
    [DebugTab("Customize Medals")]
    public class CustomizeMedalDisplaySystem : Core.System
    {
        ...
        public CustomizeMedalDisplaySystem(EntityManager em, GraphicsDevice gd, SpriteBatch sb, SpriteFont font, CardLibraryPanelSystem libraryPanel, LoadoutDeckPanelSystem deckPanel) : base(em)
        {
            _graphicsDevice = gd;
            _spriteBatch = sb;
            _font = font;
            ...
            EventManager.Subscribe<MedalRenderEvent>(OnMedalRender);
        }
        ...
        public void Draw() { /* event-driven to render inside active SpriteBatch */ }

        private void OnMedalRender(MedalRenderEvent e)
        {
