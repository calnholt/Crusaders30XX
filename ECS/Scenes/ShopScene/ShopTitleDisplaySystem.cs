...
{
	[DebugTab("Shop Title Display")]
	public class ShopTitleDisplaySystem : Core.System
	{
		...
		public ShopTitleDisplaySystem(EntityManager entityManager, GraphicsDevice graphicsDevice, SpriteBatch spriteBatch)
			: base(entityManager)
		{
			...
			{
				_title = string.IsNullOrWhiteSpace(_.Title) ? "Shop" : _.Title;
			});
		}
