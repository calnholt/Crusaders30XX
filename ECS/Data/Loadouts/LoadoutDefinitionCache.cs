...
namespace Crusaders30XX.ECS.Data.Loadouts
{
	...
	{
		private static Dictionary<string, LoadoutDefinition> _cache;
		...
		public static void Reload()
		{
			lock (_lock)
			{
				...
				_cache = LoadoutRepository.LoadFromFolder(folder);
			}
		}
		...
		private static string ResolveFolderPath()
		{
			...
			_folderPath = string.IsNullOrEmpty(root) ? string.Empty : Path.Combine(root, "ECS", "Data", "Loadouts");
			return _folderPath;
		}
