...
{
	public static class MedalDefinitionCache
	{
		private static Dictionary<string, MedalDefinition> _cache;
		private static string _folderPath;
		private static readonly object _lock = new object();

		public static bool TryGet(string id, out MedalDefinition def)
		{
			EnsureLoaded();
			return _cache.TryGetValue(id, out def);
		}

		public static Dictionary<string, MedalDefinition> GetAll()
		{
			EnsureLoaded();
			return _cache;
		}
		...
		public static void Reload()
		{
			lock (_lock)
			{
				...
				_cache = MedalDefinitionRepository.LoadFromFolder(folder);
			}
		}
		...
		private static string ResolveFolderPath()
		{
			...
			_folderPath = string.IsNullOrEmpty(root) ? string.Empty : Path.Combine(root, "ECS", "Data", "Medals");
			return _folderPath;
		}
